...
1. Calculate image hashes for de-dupe. Use heuristic process for dedupe, considering filenames, metadata (especially ids and camera info), peceptual hashing and file hashing. Relatively easy to implement in traditional database systems, but costly in operation. Challenge here is to do with the primitive services I've chosen and at reasonable cost; still much more thinking needed on this.
